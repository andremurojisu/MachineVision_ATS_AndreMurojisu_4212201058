...
# Baca file CSV
data = pd.read_csv(r'uts/emnist-bymerge-train.csv')
...
samples_per_class = 3000 // num_classes  # Sampel merata per kelas
...
if len(balanced_data) > 3000:
    balanced_data = balanced_data.sample(3000)
